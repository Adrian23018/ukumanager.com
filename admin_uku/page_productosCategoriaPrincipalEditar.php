<?php
	...
	$nombrePageUsado = 'pcp';
	$tituloPage = 'Editar Categoría Principal';
	$actualPage = 'page_productosCategoriaPrincipalEditar';
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="inicio.php?page=page_productosCategoriaPrincipal">Categorías Principales</a>
		</li>
	</ul>
</div>
<!-- BEGIN PAGE CONTENT-->
