<?php
	...
	$tituloPage = 'Editar Blog';
	$actualPage = 'page_blogsEditar';
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="inicio.php?page=page_blogs">Blog</a>
		</li>
	</ul>
</div>
<!-- BEGIN PAGE CONTENT-->
			...
			<div class="portlet-body">
				<div class="tabbable">
					<ul class="nav nav-tabs nav-tabs-lg">
						...
						<li>
							<a href="#tab_imagenes" data-toggle="tab" class="opcion-recortar" data-option="0">
								Imágenes
								<span class="badge"></span>
							</a>
						</li>
						<li>
							<a href="#tab_imagenes_secundarias" data-toggle="tab" class="opcion-recortar" data-option="1">
