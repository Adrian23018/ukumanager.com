<?php
	...
	$nombrePageUsado = 'pcs';
	$tituloPage = 'Productos de '. utf8_encode($row_sql[$prefijoAnt."nombre"]);
	$actualPage = 'page_productos';
	$btnPageNuevoUrl = 'page_productosNuevo&'.$prefijoAntAnt.'id='.$id_antant.'&'.$prefijoAnt.'id='.$id_ant;
?>
