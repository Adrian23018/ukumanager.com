...
if ($rs_sql) {
	...
	$pagTitulo = utf8_encode($row_sql['pag_titulo']);
...
<div class="content">
	...
	<form class="login-form" action="" method="post" id="login-form">
		<h3 class="form-title">Generar Clave</h3>
		...
		<div class="form-group">
			...
			<div class="input-icon right">
				...
				<input class="form-control form-control-solid placeholder-no-fix qtipmensaje" id="login-password" type="password" autocomplete="off" placeholder="Clave" name="login-password"/>
			</div>
		</div>
		<div class="js-contrasena"></div>
		<div class="form-actions text-center">
			<button type="button" class="btn btn-success uppercase" id="login-btn">Generar Clave</button>
		</div>
	</form>
	<!-- END LOGIN FORM -->
...
<script src="js/generarClave.js" type="text/javascript"></script>
<!-- END JAVASCRIPTS -->
</body>
<!-- END BODY -->
</html>