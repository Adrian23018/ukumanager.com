<?php
	...
	$nombrePageUsado = 'pcs';
	$tituloPage = 'Editar Categoría Secundaria de '. utf8_encode($row_sql[$prefijoAnt."nombre"]);
	$actualPage = 'page_productosCategoriaSecundariaEditar';
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="inicio.php?page=page_productosCategoriaSecundaria&<?php echo $prefijoAnt; ?>id=<?php echo $id_ant; ?>">Categorias Secundarias</a>
		</li>
	</ul>
</div>
<!-- BEGIN PAGE CONTENT-->
