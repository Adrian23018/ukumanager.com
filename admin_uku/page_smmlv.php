<?php
	...
	$tituloPage = 'Salario mínimo legal vigente';
	$actualPage = 'page_smmlv';
							...
							<div class="tab-pane active" id="tab_general">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">smmlv<span class="required"> * </span> (Sin signos de puntuación)</label>
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												<i class="fa fa"></i>
											</span>
											<i class="fa faicono"></i>
											<input type="text" name="<?php echo $nombrePageUsado; ?>-nombre" id="<?php echo $nombrePageUsado; ?>-nombre" placeholder="Salario" class="form-control qtipmensaje"/>
										</div>
									</div>
								</div>
							</div>
