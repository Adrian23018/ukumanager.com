<?php
	...
	$tituloPage = 'Editar Banner';
	$actualPage = 'page_bannerPrincipalEditar';
						...
						<div class="tab-content">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group input-icon right">
											...
											<i class="fa faicono"></i>
											<input type="text" class="colorpicker-rgba form-control" data-color-format="rgba" name="<?php echo $nombrePageUsado; ?>-colorrgba" id="<?php echo $nombrePageUsado; ?>-colorrgba"/>
										</div>
									</div>
								</div>
							...
							<div class="tab-pane" id="tab_imagenes">
								...
								<div class="clearfix margin-top-10">
									...
									<span> &nbsp; Debes escoger la imagen principal, que funcionará como fondo en el banner<span class="js-recomendacion-tamano"></span> Resolución 72;</span>
								</div>
								<div class="clearfix margin-top-10">
									<span class="label label-danger">NOTE! </span>
